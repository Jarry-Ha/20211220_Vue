<template>
    <div>
        ...
        <b-modal id="modalGetContact" title="Get Contactt">
            ...
            <template #modal-footer>
                <div class="w-100">
                    <b-button variant="primary" size="sm" class="float-right" @click="$bvModal.hide('modalGetContact'); $bvModal.show('modalUpdateContact');">UPDATE</b-button>
                    <b-button variant="danger" size="sm" class="float-right" @click="$bvModal.hide('modalGetContact')">DELETE</b-button>
                </div>
            </template>
        </b-modal>
