    ...
    <div class="form">
      <form method="post" enctype="multipart/form-data">
        ...
        <div>
          ...
          <label>
              <input type="file" name="photo" class="long btn btn-default" ref="photofile">
          </label>
        </div>
        <div>
          <div>&nbsp;</div>
...
<style scoped>
.modal { z-index:10; display: block;  position: fixed;  z-index: 1; left: 0; top: 0; width: 100%; height: 100%; overflow: auto; background-color: rgb(0,0,0); background-color: rgba(0,0,0,0.4);  }
.form { z-index:10;  background-color: white;  margin:100px auto; max-width: 400px;  min-width: 200px;  padding: 10px 10px 10px 10px; font: 13px "verdana"; }
